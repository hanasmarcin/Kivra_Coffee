 ...
 * Library copied from https://github.com/jsramraj/flags and slightly modified
 */
...
public class Flags {
    ...
    private final Bitmap flagSpriteBitMap;
    private final int tileWidth;
    private final int tileHeight;

    private Flags(Builder builder) {
        this.context = builder.context;
        tileWidth = builder.width > 0 ? builder.width : 128;
        tileHeight = builder.height > 0 ? builder.height : 80;
        flagSpriteBitMap = builder.flagSpriteBitMap != null ?
                           builder.flagSpriteBitMap :
                           getImageFromAssetsFile(context, "flags-sprite.png");
    }

    /**
     * Crops the flag icon for the given country code from the big sprite image of all the flag
     * icons The country code should be only two character and should follow the ISO_3166-1 standard
     * as mentioned in https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2. If not, this method will
    ...
    public BitmapDrawable forCountry(String countryCode) throws FlagsException {
        ...
        if (countryCode == null) {
            throw new NullPointerException(
                    "Country code cannot be null. Supply a valid ISO two digit country code. Refer: https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2");
        }
        if (countryCode.length() != 2) {
            throw new InvalidParameterException(
                    "Country code is not valid. Supply a valid ISO two digit country code. Refer: https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2");
        }
    ...
    public static class Builder {
        ...
        /**
         * Optionally, you can supply your own source sprite image if you want. Visit
         * https://github.com/jsramraj/flag-sprite-creator to know how you can create your own
         * sprite image If you supply your own source image, make sure you also set the correct tile
